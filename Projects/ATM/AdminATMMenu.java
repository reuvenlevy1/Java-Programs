...
public class AdminATMMenu {
    ...
    AdminATMMenu(Map<String, String> accountDetails, CSVFileHandler csv)
            ...
            try {
                ...
                if (selection.equals(ADD_ACCOUNT_NUM) || selection.equals(ADD_ACCOUNT)) {
                    ...
                    while (!validRequirements && !notDuplicate) {
                        ...
                        if (username.toLowerCase().equals(BACK.toLowerCase())) break;
                        ...
                        if (checkRequirements(username,pin)) {
                            ...
                            if (checkDupUsers(username,csv))
                                notDuplicate = true;
                            else System.out.println(Messages.accountCheckDuplicateUserErrorMessage());
                        } else System.out.println(Messages.accountCheckRequirementsErrorMessage()+"\n");
                    }

                    if (validRequirements && notDuplicate) {
                        // Add new user to accounts.csv
                        csv.addToAccountsCSV(newAccountDetails);
                        CSVFileHandler.csvOpen = true;
                        accountAdded = true;
                        System.out.println();
                        System.out.println(Messages.adminAccountCreatedMessage()+"\n\n"+Messages.exitMessage()+"\n\n");
                        break;
                    }
