...
public class ATMMenu {
    ...
    ATMMenu(Database db) throws FileNotFoundException, IOException {
        this.db = db;
        // Array of values to be added to <user.csv>:
        ...
        while (!modifyBalance_flag) {
            ...
            try {
                ...
                if (selection.equals(WITHDRAW_NUM) || selection.equals(WITHDRAW)) {                                                 //FIXME
                    ...
                    //             break;
                    //         DataHandler.checkInputForQuit(s_amount);
                ...
                } else if (selection.equals(DEPOSIT_NUM) || selection.equals(DEPOSIT)) {                                            //FIXME
                    ...
                    System.out
                            .print(TRANSACTION_HISTORY.toUpperCase() + "\n" + Messages.returnToATMMenuMessage() + "\n");
                    ...
                    System.out.println(Messages.atmMenuIncompleteMessage());
                    break;
                } else if (selection.equals(DELETE_ACCOUNT_NUM) || selection.equals(DELETE_ACCOUNT)) {                                              //FIXME
                    // DELETE ACCOUNT
                    ...
                    if (confirmUserInput.toLowerCase().equals(BACK.toLowerCase()))
                        break;
                    DataHandler.checkInputForQuit(confirmUserInput);
        ...
        if (modifyBalance_flag) {                                                       //FIXME
            ...
            // csv.addToUserCSV(accountDetails, currentTransaction);            //FIXME
    ...
    private double withdraw(double amount, double balance) {
        if (amount <= balance) {
            ...
            System.out.println(Messages.withdrawErrorMessage(DataHandler.beautifier(Double.toString(amount)),
    ...
    private double deposit(double amount, double balance) {
        if (amount >= 0.01) {
            ...
            System.out.println(Messages.depositErrorMessage(DataHandler.beautifier(Double.toString(amount)),
                    DataHandler.beautifier(Double.toString(balance))));
        }
        return balance;
    }
